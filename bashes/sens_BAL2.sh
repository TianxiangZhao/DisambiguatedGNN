                      ...
                      do
                        for class_weight in ${Class_weights[*]}
                          do
                            ...
                            CUDA_VISIBLE_DEVICES=0 python BAL_main.py --dataset=$dataset --method=$method --loss=$loss --log --task=$task --epochs=$epoch --normalize --SUPBAL --BAL_weights ${weights[*]} --debias --groupnumber=$groupnumber
